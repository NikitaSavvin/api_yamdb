# Generated by Django 3.0.5 on 2021-04-11 20:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, db_index=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='category_Title', to='yamdb.Category')),
                ('genre', models.ManyToManyField(blank=True, related_name='Title_Genre', to='yamdb.Genre')),
            ],
            options={
