...
v1_router.register('categories', CategoryViewSet, basename='v1_Category')
v1_router.register('genres', GenreViewSet, basename='v1_Genre')
v1_router.register('titles', TitleViewSet, basename='v1_Title')
